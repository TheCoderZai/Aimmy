...
> If you enjoy Aimmy, please consider giving us a star ⭐! We appreciate it! :)
  <p>
    <a href="https://github.com/TheCoderZai/Aimmy/tree/main/" target="_blank">
      <img width="100%" src="https://raw.githubusercontent.com/TheCoderZai/Aimmy/master/readme_assets/AimmyV2Banner.png"></a>
  </p>
...
Aimmy is 100% free to use. This means no ads, no key system, and no paywalled features. Aimmy is not, and will never be for sale for the end user, and is considered a [source-available](https://github.com/TheCoderZai/Aimmy/blob/master/SourceAvailable.md) product, as we actively discourage other developers from making commercial forks of Aimmy.

If you want to share Aimmy with your friends, our github is: https://github.com/TheCoderZai/Aimmy/tree/main/
...
- Download Aimmy from [Releases](https://github.com/TheCoderZai/Aimmy/releases) (Make sure it's the Aimmy zip and not Source zip)
...
![Example of Model switching](https://github.com/TheCoderZai/Aimmy/blob/master/readme_assets/UI.gif?raw=true)
...
Aimmy pulls these models from the [Aimmy repository](https://github.com/TheCoderZai/Aimmy/tree/master/models), this means **anyone can upload models to the "Downloadable Models" tab by making a pull request**.
